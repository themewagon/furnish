...
<html lang="en">
  ...
  <title>About eCommerce Bootstrap HTML Template - Furnish</title>
...
<main>
        ...
        <div class="row g-4">
          <div class="col-md-4">
            <div class="card rounded-0 border-0 shadow-sm h-100 p-4">
              <div class="card-body">
               <div class="mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor" class="bi bi-tree" viewBox="0 0 16 16">
  <path d="M8.416.223a.5.5 0 0 0-.832 0l-3 4.5A.5.5 0 0 0 5 5.5h.098L3.076 8.735A.5.5 0 0 0 3.5 9.5h.191l-1.638 3.276a.5.5 0 0 0 .447.724H7V16h2v-2.5h4.5a.5.5 0 0 0 .447-.724L12.31 9.5h.191a.5.5 0 0 0 .424-.765L10.902 5.5H11a.5.5 0 0 0 .416-.777zM6.437 4.758A.5.5 0 0 0 6 4.5h-.066L8 1.401 10.066 4.5H10a.5.5 0 0 0-.424.765L11.598 8.5H11.5a.5.5 0 0 0-.447.724L12.69 12.5H3.309l1.638-3.276A.5.5 0 0 0 4.5 8.5h-.098l2.022-3.235a.5.5 0 0 0 .013-.507"/>
</svg>
               </div>
                <h3 class="h5">Sustainability</h3>
                <p class="text-muted">We use responsibly sourced materials to ensure our furniture supports a greener planet.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
  ...
  <path d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1z"/>
                ...
                <p class="text-muted">Every piece undergoes rigorous testing to guarantee durability and comfort.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
  ...
  <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001m-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708z"/>
                ...
                <p class="text-muted">Our designs blend modern aesthetics with functional elegance for every home.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="py-lg-8 py-5">
      <div class="container text-center">
        ...
        <div class="row g-4">
          <div class="col-6 col-md-3">
            <div class="mx-md-8">
            <img src="./assets/images/avatar-1.jpg" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
          ...
          <div class="col-6 col-md-3">
             <div class="mx-md-8">
            <img src="./assets/images/avatar-2.jpg" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
            <h3 class=" mb-1 h5">
          Michael Brown</h3>
          ...
          <div class="col-6 col-md-3">
             <div class="mx-md-8">
            <img src="./assets/images/avatar-3.jpg" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
          ...
          <div class="col-6 col-md-3">
            <div class="mx-md-8">
            <img src="./assets/images/avatar-4.jpg" class="rounded-circle img-fluid mb-3" alt="Team member">
            </div>
            <div class="lh-1">
      ...
      <span>Template</span>
          ...
          </footer>  <div class="position-fixed end-0 bottom-0 m-4 z-1">
