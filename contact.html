...
<html lang="en">
  ...
  <title>Contact eCommerce Bootstrap HTML Template - Furnish</title>
  ...
  <div class="container-fluid px-0">
    <a class="navbar-brand" href="index.html">
      <span class="d-flex flex-column text-uppercase text-xs  lh-sm fw-bold">
    ...
    <div class="d-flex align-items-center gap-4">
        <span class="d-flex align-items-center gap-2 ">
            ...
            <span class="fw-bold">+901234576</span>
        </span>
      ...
      <div class="container">
        <div class="row g-5 align-items-start">
          ...
          <div class="col-md-4">
            ...
            <p class="text-muted mb-4">Whether you have a question about our products, need assistance, or just want to talk furniture — we’re here for you.</p>
