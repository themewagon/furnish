...
<html lang="en">
  <head>
   ...
   <title>Products eCommerce Bootstrap HTML Template - Furnish</title>
        ...
        <div class="row g-4">
          ...
          <div class="col-sm-6 col-md-4">
            <div class="card product-card">
              <a href="#"><img src="./assets/images/product-img-1.jpg" class="card-img-top" alt="Product Name"></a>
              <div class="card-body">
            ...
            <div class="card product-card">
              <a href="#"><img src="./assets/images/product-img-2.jpg" class="card-img-top" alt="Product Name"></a>
              <div class="card-body">
                 <p class="text-muted mb-2 text-uppercase text-xs mb-3">Brand</p>
                  <div class="mb-3">
          ...
          <!-- /Repeat -->
            <div class="col-sm-6 col-md-4">
            <div class="card product-card">
              <a href="#"><img src="./assets/images/product-img-5.jpg" class="card-img-top" alt="Product Name"></a>
              <div class="card-body">
                 <p class="text-muted mb-2 text-uppercase text-xs mb-3">Brand</p>
                  <div class="mb-3">
                ...
                <div class="col-sm-6 col-md-4">
            <div class="card product-card">
              <a href="#"><img src="./assets/images/product-img-6.jpg" class="card-img-top" alt="Product Name"></a>
              <div class="card-body">
                 <p class="text-muted mb-2 text-uppercase text-xs mb-3">Brand</p>
                  <div class="mb-3">
            ...
            <div class="card product-card">
              <a href="#"><img src="./assets/images/product-img-3.jpg" class="card-img-top" alt="Product Name"></a>
              <div class="card-body">
                 <p class="text-muted mb-2 text-uppercase text-xs mb-3">Brand</p>
                  <div class="mb-3">
          ...
          <!-- /Repeat -->
            <div class="col-sm-6 col-md-4">
            <div class="card product-card">
              <a href="#"><img src="./assets/images/product-img-7.jpg" class="card-img-top" alt="Product Name"></a>
              <div class="card-body">
                 <p class="text-muted mb-2 text-uppercase text-xs mb-3">Brand</p>
                  <div class="mb-3">
